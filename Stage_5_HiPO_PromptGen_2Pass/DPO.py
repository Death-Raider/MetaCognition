...
from Stage_5_HiPO_PromptGen_2Pass.PromptGenerator import gen_prompt_from_query
...
class DirectPreferenceOptimization:
    ...
    def batch_prompts(self, prompts, pad_token_id):
    ...
    def dpo_loss(self, batch, beta):
        # Taken from analysis of PromptGeneratorOptimization/prompt.txt and PromptGeneratorOptimization/query_prompt.txt
        prompt_instruction = """
        ...
        P_a = self.batch_prompts(P_a, self.tokenizer.pad_token_id)
        ...
        # prompt_text = self.tokenizer.decode(P_a['input_ids'][0], skip_special_tokens=True)
        ...
        P_b = self.batch_prompts(P_b, self.tokenizer.pad_token_id)
