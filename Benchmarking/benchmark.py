from GSM8K_bench import GSM8K, GSM8K_Bench
from GPT_bench import GPT, GPT_Bench
...
def bench(model, tokenizer, prompt_instruction:str=None):
    ...
    math500 = MATH500()
    bench_math = MATH500_Bench(model, tokenizer, math500, device="cuda" if torch.cuda.is_available() else "cpu")
    ...
    results = results_gsm['details'] + results_math['details']
