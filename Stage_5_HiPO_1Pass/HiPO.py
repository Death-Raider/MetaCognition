...
class HierarchicalPreferenceOptimization:
    ...
    def set_models(self, MODEL_NAME):
        ...
        self.policy_model = AutoModelForCausalLM.from_pretrained(MODEL_NAME,dtype=torch.bfloat16).to(self.device)
    ...
    def hipo_loss(self, batch, Prompt_Instruction,beta,weights):
        ...
        loss = loss_M*w_M + loss_T*w_T + loss_A*w_A + loss_MTAS*w_MTAS # Loss by Rq + Loss by Mt + Loss by Ra + Loss by complete Trace
